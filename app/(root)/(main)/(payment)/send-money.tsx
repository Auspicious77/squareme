...
const SendMoney: React.FC = () => {
    ...
    const data = [
        { id: '1', title: 'Send to bank account', iconName: 'bank-outline' },
        { id: '2', title: 'Send to beneficiary', iconName: 'account-multiple-plus' },
        { id: '3', title: 'Send using sqaureme tag', iconName: 'account-group' },
        { id: '4', title: 'Send to contact list', iconName: 'plus' }
    ]
        ...
        <SafeAreaView style={styles.page}>
            ...
            <View
                ...
                <Button
                    ...
                    onPress={() => router.navigate('/send-money-main')}
                />
            </View>
            ...
            >
                <Text style={{ ...styles.text2, color: COLORS.black, fontSize: 18, paddingTop: scale(20), textAlign: 'left' }}>Where do you want to send money?</Text>
                <FlatList
                    data={data}
